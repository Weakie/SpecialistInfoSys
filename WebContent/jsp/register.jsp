...
<script type="text/javascript">
	...
	function confirmUsernameExist() {
		...
		var url = "/SpecialistInfoSys/usernameConfirm.action?personBean.userName="+userName;
	...
	<div class="col-md-12 column">
		...
		<br><br><br><br>
			<div class="row clearfix">
				...
				<div class="col-md-4 column">
					<br><br>
					<form action="/SpecialistInfoSys/register.action" method="post" onsubmit="return checkform();" class="form-horizontal" role="form">
						<div class="form-group" id="username_div_parent">
							<label for="userName" class="col-sm-3 control-label">用户名</label>
							<div class="col-sm-8" id="username_div">
								<input type="text" class="form-control" id="userName" name="personBean.userName" onblur="confirmUsernameExist()" onkeyup="confirmUsernameExist()" />
							</div>
						</div>
